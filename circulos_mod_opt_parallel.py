...
from in_circle_opt_parallel import draw_canvas,draw_circle
...
if __name__ == "__main__":
    ...
    for i in range(n_circulos):
        ...
        cuadro[0],cuadro[1],cuadro[2]=draw_circle(array.array("i",circulo_int), array.array("i",cuadro[0]),array.array("i",cuadro[1]),array.array("i",cuadro[2]), width, height)
        #draw_circle(array.array("i",circulo_int),cuadro,width,height)

    writePPM(cuadro[0].tolist(), cuadro[1].tolist(), cuadro[2].tolist(), width, height, "salida")
