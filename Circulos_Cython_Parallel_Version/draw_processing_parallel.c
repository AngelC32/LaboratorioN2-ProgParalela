...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "draw_processing_parallel",
        "sources": [
            "draw_processing_parallel.pyx"
        ]
    },
    "module_name": "draw_processing_parallel"
}
END: Cython Metadata */
...
#define __PYX_HAVE__draw_processing_parallel
#define __PYX_HAVE_API__draw_processing_parallel
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "pythread.h"
...
/* Module declarations from 'draw_processing_parallel' */
...
static int __pyx_f_24draw_processing_parallel_comprobar_pixel(int, int); /*proto*/
static int __pyx_f_24draw_processing_parallel_in_circle(int, int, int, int, int); /*proto*/
...
#define __Pyx_MODULE_NAME "draw_processing_parallel"
extern int __pyx_module_is_main_draw_processing_parallel;
int __pyx_module_is_main_draw_processing_parallel = 0;

/* Implementation of 'draw_processing_parallel' */
...
static const char __pyx_k_eje_X[] = "eje_X";
static const char __pyx_k_eje_Y[] = "eje_Y";
...
static const char __pyx_k_cuadro[] = "cuadro";
...
static const char __pyx_k_circulo[] = "circulo";
...
static const char __pyx_k_draw_processing_parallel[] = "draw_processing_parallel";
static const char __pyx_k_Invalid_shape_in_axis_d_d[] = "Invalid shape in axis %d: %d.";
static const char __pyx_k_itemsize_0_for_cython_array[] = "itemsize <= 0 for cython.array";
static const char __pyx_k_draw_processing_parallel_pyx[] = "draw_processing_parallel.pyx";
...
static PyObject *__pyx_n_s_circulo;
...
static PyObject *__pyx_n_s_cuadro;
static PyObject *__pyx_n_s_dict;
static PyObject *__pyx_n_s_draw_canvas;
static PyObject *__pyx_n_s_draw_circle;
static PyObject *__pyx_n_s_draw_processing_parallel;
static PyObject *__pyx_kp_s_draw_processing_parallel_pyx;
static PyObject *__pyx_n_s_dtype_is_object;
static PyObject *__pyx_n_s_eje_X;
static PyObject *__pyx_n_s_eje_Y;
...
static PyObject *__pyx_n_s_template_array;
...
static PyObject *__pyx_pf_24draw_processing_parallel_draw_circle(CYTHON_UNUSED PyObject *__pyx_self, arrayobject *__pyx_v_circulo, PyObject *__pyx_v_cuadro, int __pyx_v_width, int __pyx_v_height); /* proto */
static PyObject *__pyx_pf_24draw_processing_parallel_2draw_canvas(CYTHON_UNUSED PyObject *__pyx_self, unsigned int __pyx_v_width, unsigned int __pyx_v_height); /* proto */
...
/* "draw_processing_parallel.pyx":6
 * 
 * @boundscheck(False)
...
/* Python wrapper */
static PyObject *__pyx_pw_24draw_processing_parallel_1draw_circle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_24draw_processing_parallel_1draw_circle = {"draw_circle", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_24draw_processing_parallel_1draw_circle, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_24draw_processing_parallel_1draw_circle(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  arrayobject *__pyx_v_circulo = 0;
  PyObject *__pyx_v_cuadro = 0;
  int __pyx_v_width;
  int __pyx_v_height;
  int __pyx_lineno = 0;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_circulo,&__pyx_n_s_cuadro,&__pyx_n_s_width,&__pyx_n_s_height,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_circulo)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_cuadro)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("draw_circle", 1, 4, 4, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_width)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("draw_circle", 1, 4, 4, 2); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_height)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("draw_circle", 1, 4, 4, 3); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "draw_circle") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
    ...
    __pyx_v_circulo = ((arrayobject *)values[0]);
    __pyx_v_cuadro = values[1];
    __pyx_v_width = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_width == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
    __pyx_v_height = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_height == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 6, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("draw_circle", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("draw_processing_parallel.draw_circle", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_circulo), __pyx_ptype_7cpython_5array_array, 1, "circulo", 0))) __PYX_ERR(0, 6, __pyx_L1_error)
  __pyx_r = __pyx_pf_24draw_processing_parallel_draw_circle(__pyx_self, __pyx_v_circulo, __pyx_v_cuadro, __pyx_v_width, __pyx_v_height);
...
static PyObject *__pyx_pf_24draw_processing_parallel_draw_circle(CYTHON_UNUSED PyObject *__pyx_self, arrayobject *__pyx_v_circulo, PyObject *__pyx_v_cuadro, int __pyx_v_width, int __pyx_v_height) {
  int __pyx_v_eje_Y;
  int __pyx_v_eje_X;
  int __pyx_v_radio;
  int __pyx_v_color_red;
  int __pyx_v_color_green;
  int __pyx_v_color_blue;
  ...
  __Pyx_INCREF(__pyx_v_cuadro);

  /* "draw_processing_parallel.pyx":7
 * @boundscheck(False)
 * def draw_circle(array.array circulo, cuadro, int width, int height):
 *     cdef int eje_Y=circulo.data.as_ints[0]             # <<<<<<<<<<<<<<
 *     cdef int eje_X=circulo.data.as_ints[1]
 ...
 */
  __pyx_v_eje_Y = (__pyx_v_circulo->data.as_ints[0]);

  /* "draw_processing_parallel.pyx":8
 * def draw_circle(array.array circulo, cuadro, int width, int height):
 *     cdef int eje_Y=circulo.data.as_ints[0]
 *     cdef int eje_X=circulo.data.as_ints[1]             # <<<<<<<<<<<<<<
 *     cdef int radio=circulo.data.as_ints[2]
 ...
 */
  __pyx_v_eje_X = (__pyx_v_circulo->data.as_ints[1]);

  /* "draw_processing_parallel.pyx":9
 *     cdef int eje_Y=circulo.data.as_ints[0]
 *     cdef int eje_X=circulo.data.as_ints[1]
 *     cdef int radio=circulo.data.as_ints[2]             # <<<<<<<<<<<<<<
 *     cdef int color_red=circulo.data.as_ints[3]
 ...
 */
  __pyx_v_radio = (__pyx_v_circulo->data.as_ints[2]);

  /* "draw_processing_parallel.pyx":10
 *     cdef int eje_X=circulo.data.as_ints[1]
 *     cdef int radio=circulo.data.as_ints[2]
 *     cdef int color_red=circulo.data.as_ints[3]             # <<<<<<<<<<<<<<
 *     cdef int color_green=circulo.data.as_ints[4]
 ...
 */
  __pyx_v_color_red = (__pyx_v_circulo->data.as_ints[3]);

  /* "draw_processing_parallel.pyx":11
 *     cdef int radio=circulo.data.as_ints[2]
 *     cdef int color_red=circulo.data.as_ints[3]
 *     cdef int color_green=circulo.data.as_ints[4]             # <<<<<<<<<<<<<<
 *     cdef int color_blue=circulo.data.as_ints[5]
 ...
 */
  __pyx_v_color_green = (__pyx_v_circulo->data.as_ints[4]);

  /* "draw_processing_parallel.pyx":12
 *     cdef int color_red=circulo.data.as_ints[3]
 *     cdef int color_green=circulo.data.as_ints[4]
 *     cdef int color_blue=circulo.data.as_ints[5]             # <<<<<<<<<<<<<<
 *     cdef int[:]red=cuadro[0]
 ...
 */
  __pyx_v_color_blue = (__pyx_v_circulo->data.as_ints[5]);

  /* "draw_processing_parallel.pyx":13
 *     cdef int color_green=circulo.data.as_ints[4]
 *     cdef int color_blue=circulo.data.as_ints[5]
 *     cdef int[:]red=cuadro[0]             # <<<<<<<<<<<<<<
 *     cdef int[:]green=cuadro[1]
 ...
 */
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_cuadro, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_2.memview)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_red = __pyx_t_2;
  __pyx_t_2.memview = NULL;
  __pyx_t_2.data = NULL;

  /* "draw_processing_parallel.pyx":14
 *     cdef int color_blue=circulo.data.as_ints[5]
 *     cdef int[:]red=cuadro[0]
 *     cdef int[:]green=cuadro[1]             # <<<<<<<<<<<<<<
 *     cdef int[:]blue=cuadro[2]
 *     cdef int i,j
 */
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_cuadro, 1, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_2.memview)) __PYX_ERR(0, 14, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_green = __pyx_t_2;
  __pyx_t_2.memview = NULL;
  __pyx_t_2.data = NULL;

  /* "draw_processing_parallel.pyx":15
 *     cdef int[:]red=cuadro[0]
 *     cdef int[:]green=cuadro[1]
 *     cdef int[:]blue=cuadro[2]             # <<<<<<<<<<<<<<
 *     cdef int i,j
 *     cdef int h=height
 */
  __pyx_t_1 = __Pyx_GetItemInt(__pyx_v_cuadro, 2, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_1, PyBUF_WRITABLE); if (unlikely(!__pyx_t_2.memview)) __PYX_ERR(0, 15, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_blue = __pyx_t_2;
  __pyx_t_2.memview = NULL;
  __pyx_t_2.data = NULL;

  /* "draw_processing_parallel.pyx":17
 *     cdef int[:]blue=cuadro[2]
 *     cdef int i,j
 *     cdef int h=height             # <<<<<<<<<<<<<<
 *     cdef int w=width
 ...
 */
  ...
  /* "draw_processing_parallel.pyx":18
 *     cdef int i,j
 *     cdef int h=height
 *     cdef int w=width             # <<<<<<<<<<<<<<
 *     cdef int index
 ...
 */
  ...
  /* "draw_processing_parallel.pyx":20
 *     cdef int w=width
 *     cdef int index
 *     for i in prange(h, nogil=True):             # <<<<<<<<<<<<<<
 *         for j in range(w):
      ...
      /*try:*/ {
        ...
        if ((1 == 0)) abort();
        {
            ...
            if (__pyx_t_5 > 0)
            {
                ...
                {
                    #ifdef _OPENMP
                    #pragma omp for firstprivate(__pyx_v_i) lastprivate(__pyx_v_i) lastprivate(__pyx_v_index) lastprivate(__pyx_v_j)
                    #endif /* _OPENMP */
                    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_5; __pyx_t_4++){
                        {
                            ...
                            /* "draw_processing_parallel.pyx":21
 *     cdef int index
 *     for i in prange(h, nogil=True):
 *         for j in range(w):             # <<<<<<<<<<<<<<
 *             if(in_circle(eje_X,eje_Y,i,j,radio)):
 ...
 */
                            ...
                            for (__pyx_t_8 = 0; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
                              ...
                              /* "draw_processing_parallel.pyx":22
 *     for i in prange(h, nogil=True):
 *         for j in range(w):
 *             if(in_circle(eje_X,eje_Y,i,j,radio)):             # <<<<<<<<<<<<<<
 *                 index = j+i*width
 ...
 */
                              __pyx_t_9 = (__pyx_f_24draw_processing_parallel_in_circle(__pyx_v_eje_X, __pyx_v_eje_Y, __pyx_v_i, __pyx_v_j, __pyx_v_radio) != 0);
                              if (__pyx_t_9) {

                                /* "draw_processing_parallel.pyx":23
 *         for j in range(w):
 *             if(in_circle(eje_X,eje_Y,i,j,radio)):
 *                 index = j+i*width             # <<<<<<<<<<<<<<
 *                 red[index]=comprobar_pixel(red[index],color_red)
 ...
 */
                                __pyx_v_index = (__pyx_v_j + (__pyx_v_i * __pyx_v_width));

                                /* "draw_processing_parallel.pyx":24
 *             if(in_circle(eje_X,eje_Y,i,j,radio)):
 *                 index = j+i*width
 *                 red[index]=comprobar_pixel(red[index],color_red)             # <<<<<<<<<<<<<<
 *                 green[index]=comprobar_pixel(green[index],color_green)
 ...
 */
                                ...
                                if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_red.shape[0];
                                __pyx_t_11 = __pyx_v_index;
                                if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_red.shape[0];
                                *((int *) ( /* dim=0 */ (__pyx_v_red.data + __pyx_t_11 * __pyx_v_red.strides[0]) )) = __pyx_f_24draw_processing_parallel_comprobar_pixel((*((int *) ( /* dim=0 */ (__pyx_v_red.data + __pyx_t_10 * __pyx_v_red.strides[0]) ))), __pyx_v_color_red);

                                /* "draw_processing_parallel.pyx":25
 *                 index = j+i*width
 *                 red[index]=comprobar_pixel(red[index],color_red)
 *                 green[index]=comprobar_pixel(green[index],color_green)             # <<<<<<<<<<<<<<
 *                 blue[index]=comprobar_pixel(blue[index],color_blue)
 ...
 */
                                __pyx_t_10 = __pyx_v_index;
                                if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_green.shape[0];
                                __pyx_t_11 = __pyx_v_index;
                                if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_green.shape[0];
                                *((int *) ( /* dim=0 */ (__pyx_v_green.data + __pyx_t_11 * __pyx_v_green.strides[0]) )) = __pyx_f_24draw_processing_parallel_comprobar_pixel((*((int *) ( /* dim=0 */ (__pyx_v_green.data + __pyx_t_10 * __pyx_v_green.strides[0]) ))), __pyx_v_color_green);

                                /* "draw_processing_parallel.pyx":26
 *                 red[index]=comprobar_pixel(red[index],color_red)
 *                 green[index]=comprobar_pixel(green[index],color_green)
 *                 blue[index]=comprobar_pixel(blue[index],color_blue)             # <<<<<<<<<<<<<<
 * 
 ...
 */
                                __pyx_t_10 = __pyx_v_index;
                                if (__pyx_t_10 < 0) __pyx_t_10 += __pyx_v_blue.shape[0];
                                __pyx_t_11 = __pyx_v_index;
                                if (__pyx_t_11 < 0) __pyx_t_11 += __pyx_v_blue.shape[0];
                                *((int *) ( /* dim=0 */ (__pyx_v_blue.data + __pyx_t_11 * __pyx_v_blue.strides[0]) )) = __pyx_f_24draw_processing_parallel_comprobar_pixel((*((int *) ( /* dim=0 */ (__pyx_v_blue.data + __pyx_t_10 * __pyx_v_blue.strides[0]) ))), __pyx_v_color_blue);
 ...
 */
  ...
  /* "draw_processing_parallel.pyx":28
 *                 blue[index]=comprobar_pixel(blue[index],color_blue)
 * 
 *     cuadro=[red,green,blue]             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_1 = __pyx_memoryview_fromslice(__pyx_v_red, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_12 = __pyx_memoryview_fromslice(__pyx_v_green, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_12)) __PYX_ERR(0, 28, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_12);
  __pyx_t_13 = __pyx_memoryview_fromslice(__pyx_v_blue, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 28, __pyx_L1_error)
  ...
  __pyx_t_12 = 0;
  __pyx_t_13 = 0;
  __Pyx_DECREF_SET(__pyx_v_cuadro, __pyx_t_14);
  __pyx_t_14 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_v_cuadro);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "draw_processing_parallel.pyx":29
 * 
 *     cuadro=[red,green,blue]
 * cdef int comprobar_pixel(int oldPixel,int newPixel)nogil:             # <<<<<<<<<<<<<<
 *     return oldPixel ^ newPixel
...
static int __pyx_f_24draw_processing_parallel_comprobar_pixel(int __pyx_v_oldPixel, int __pyx_v_newPixel) {
  int __pyx_r;

  /* "draw_processing_parallel.pyx":30
 *     cuadro=[red,green,blue]
 * cdef int comprobar_pixel(int oldPixel,int newPixel)nogil:
 *     return oldPixel ^ newPixel             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = (__pyx_v_oldPixel ^ __pyx_v_newPixel);
  goto __pyx_L0;
...
/* "draw_processing_parallel.pyx":33
 * 
 * 
...
static int __pyx_f_24draw_processing_parallel_in_circle(int __pyx_v_Cent_x, int __pyx_v_Cent_y, int __pyx_v_coord_x, int __pyx_v_coord_y, int __pyx_v_radio) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_Cx;
  int __pyx_v_Cy;
  ...
  /* "draw_processing_parallel.pyx":34
 * 
 * cdef int in_circle( int Cent_x,  int Cent_y , int coord_x,  int coord_y,  int radio)nogil:
 *     cdef  int x = Cent_x             # <<<<<<<<<<<<<<
 *     cdef  int y = Cent_y
 *     cdef  int Cx = coord_x
 */
  __pyx_v_x = __pyx_v_Cent_x;

  /* "draw_processing_parallel.pyx":35
 * cdef int in_circle( int Cent_x,  int Cent_y , int coord_x,  int coord_y,  int radio)nogil:
 *     cdef  int x = Cent_x
 *     cdef  int y = Cent_y             # <<<<<<<<<<<<<<
 *     cdef  int Cx = coord_x
 *     cdef  int Cy = coord_y
 */
  __pyx_v_y = __pyx_v_Cent_y;

  /* "draw_processing_parallel.pyx":36
 *     cdef  int x = Cent_x
 *     cdef  int y = Cent_y
 *     cdef  int Cx = coord_x             # <<<<<<<<<<<<<<
 *     cdef  int Cy = coord_y
 *     cdef  int r = radio
 */
  __pyx_v_Cx = __pyx_v_coord_x;

  /* "draw_processing_parallel.pyx":37
 *     cdef  int y = Cent_y
 *     cdef  int Cx = coord_x
 *     cdef  int Cy = coord_y             # <<<<<<<<<<<<<<
 *     cdef  int r = radio
 ...
 */
  __pyx_v_Cy = __pyx_v_coord_y;

  /* "draw_processing_parallel.pyx":38
 *     cdef  int Cx = coord_x
 *     cdef  int Cy = coord_y
 *     cdef  int r = radio             # <<<<<<<<<<<<<<
 *     if ((Cx-x)**2 + (Cy-y)**2) <= (r**2):
 *         return 1
 */
  __pyx_v_r = __pyx_v_radio;

  /* "draw_processing_parallel.pyx":39
 *     cdef  int Cy = coord_y
 *     cdef  int r = radio
 *     if ((Cx-x)**2 + (Cy-y)**2) <= (r**2):             # <<<<<<<<<<<<<<
 *         return 1
 *     return 0
 */
  __pyx_t_1 = (((__Pyx_pow_long(((long)(__pyx_v_Cx - __pyx_v_x)), 2) + __Pyx_pow_long(((long)(__pyx_v_Cy - __pyx_v_y)), 2)) <= __Pyx_pow_long(((long)__pyx_v_r), 2)) != 0);
  if (__pyx_t_1) {

    /* "draw_processing_parallel.pyx":40
 *     cdef  int r = radio
 *     if ((Cx-x)**2 + (Cy-y)**2) <= (r**2):
 *         return 1             # <<<<<<<<<<<<<<
 *     return 0
 ...
 */
  ...
  /* "draw_processing_parallel.pyx":41
 *     if ((Cx-x)**2 + (Cy-y)**2) <= (r**2):
 *         return 1
 *     return 0             # <<<<<<<<<<<<<<
 * 
...
/* "draw_processing_parallel.pyx":48
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_24draw_processing_parallel_3draw_canvas(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_24draw_processing_parallel_3draw_canvas = {"draw_canvas", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_24draw_processing_parallel_3draw_canvas, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_24draw_processing_parallel_3draw_canvas(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("draw_canvas (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_height)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("draw_canvas", 1, 2, 2, 1); __PYX_ERR(0, 48, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "draw_canvas") < 0)) __PYX_ERR(0, 48, __pyx_L3_error)
      }
    ...
    __pyx_v_width = __Pyx_PyInt_As_unsigned_int(values[0]); if (unlikely((__pyx_v_width == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L3_error)
    __pyx_v_height = __Pyx_PyInt_As_unsigned_int(values[1]); if (unlikely((__pyx_v_height == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 48, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("draw_canvas", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 48, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("draw_processing_parallel.draw_canvas", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_24draw_processing_parallel_2draw_canvas(__pyx_self, __pyx_v_width, __pyx_v_height);
...
static PyObject *__pyx_pf_24draw_processing_parallel_2draw_canvas(CYTHON_UNUSED PyObject *__pyx_self, unsigned int __pyx_v_width, unsigned int __pyx_v_height) {
  unsigned int __pyx_v_i;
  unsigned int __pyx_v_w;
  unsigned int __pyx_v_h;
  unsigned int __pyx_v_size;
  arrayobject *__pyx_v_template_array = 0;
  arrayobject *__pyx_v_red = 0;
  arrayobject *__pyx_v_green = 0;
  arrayobject *__pyx_v_blue = 0;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("draw_canvas", 0);

  /* "draw_processing_parallel.pyx":50
 * def draw_canvas( unsigned int width, unsigned int height ):
 *     cdef unsigned int i
 *     cdef unsigned int w = width             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "draw_processing_parallel.pyx":51
 *     cdef unsigned int i
 *     cdef unsigned int w = width
 *     cdef unsigned int h = height             # <<<<<<<<<<<<<<
 *     cdef unsigned int size = w*h
 ...
 */
  ...
  /* "draw_processing_parallel.pyx":52
 *     cdef unsigned int w = width
 *     cdef unsigned int h = height
 *     cdef unsigned int size = w*h             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_size = (__pyx_v_w * __pyx_v_h);

  /* "draw_processing_parallel.pyx":54
 *     cdef unsigned int size = w*h
 * 
 *     cdef  array.array template_array = array.array('i', [])             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_v_template_array = ((arrayobject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "draw_processing_parallel.pyx":58
 *     cdef  array.array green
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_template_array, __pyx_v_size, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 58, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_red = ((arrayobject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "draw_processing_parallel.pyx":59
 *     cdef  array.array blue
 *     red= array.clone(template_array, size, zero=False)
 *     green= array.clone(template_array, size, zero=False)             # <<<<<<<<<<<<<<
 *     blue= array.clone(template_array, size, zero=False)
 * 
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_template_array, __pyx_v_size, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 59, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_green = ((arrayobject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "draw_processing_parallel.pyx":60
 *     red= array.clone(template_array, size, zero=False)
 *     green= array.clone(template_array, size, zero=False)
 *     blue= array.clone(template_array, size, zero=False)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = ((PyObject *)__pyx_f_7cpython_5array_clone(__pyx_v_template_array, __pyx_v_size, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 60, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_blue = ((arrayobject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "draw_processing_parallel.pyx":62
 *     blue= array.clone(template_array, size, zero=False)
 * 
 *     for i in prange(size, nogil=True):             # <<<<<<<<<<<<<<
        ...
        if ((1 == 0)) abort();
        {
            ...
            if (__pyx_t_5 > 0)
            {
                ...
                #endif /* _OPENMP */
                {
                    ...
                    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_5; __pyx_t_4++){
                        {
                            __pyx_v_i = (unsigned int)(0 + 1 * __pyx_t_4);

                            /* "draw_processing_parallel.pyx":63
 * 
 *     for i in prange(size, nogil=True):
 *        red.data.as_ints[i]=0             # <<<<<<<<<<<<<<
 *        green.data.as_ints[i]=0
 ...
 */
                            (__pyx_v_red->data.as_ints[__pyx_v_i]) = 0;

                            /* "draw_processing_parallel.pyx":64
 *     for i in prange(size, nogil=True):
 *        red.data.as_ints[i]=0
 *        green.data.as_ints[i]=0             # <<<<<<<<<<<<<<
 *        blue.data.as_ints[i]=0
 * 
 */
                            (__pyx_v_green->data.as_ints[__pyx_v_i]) = 0;

                            /* "draw_processing_parallel.pyx":65
 *        red.data.as_ints[i]=0
 *        green.data.as_ints[i]=0
 *        blue.data.as_ints[i]=0             # <<<<<<<<<<<<<<
 * 
 ...
 */
                            (__pyx_v_blue->data.as_ints[__pyx_v_i]) = 0;
                        }
                    }
                }
            }
 ...
 */
  ...
  /* "draw_processing_parallel.pyx":67
 *        blue.data.as_ints[i]=0
 * 
 *     return [red, green, blue]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_INCREF(((PyObject *)__pyx_v_red));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_red));
  PyList_SET_ITEM(__pyx_t_1, 0, ((PyObject *)__pyx_v_red));
  __Pyx_INCREF(((PyObject *)__pyx_v_green));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_green));
  PyList_SET_ITEM(__pyx_t_1, 1, ((PyObject *)__pyx_v_green));
  __Pyx_INCREF(((PyObject *)__pyx_v_blue));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_blue));
  PyList_SET_ITEM(__pyx_t_1, 2, ((PyObject *)__pyx_v_blue));
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __Pyx_XDECREF((PyObject *)__pyx_v_template_array);
  __Pyx_XDECREF((PyObject *)__pyx_v_red);
  __Pyx_XDECREF((PyObject *)__pyx_v_green);
  __Pyx_XDECREF((PyObject *)__pyx_v_blue);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "draw_processing_parallel.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "draw_processing_parallel.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "draw_processing_parallel.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "draw_processing_parallel._memoryviewslice", /*tp_name*/
...
static int __pyx_pymod_exec_draw_processing_parallel(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_draw_processing_parallel},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_circulo, __pyx_k_circulo, sizeof(__pyx_k_circulo), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_cuadro, __pyx_k_cuadro, sizeof(__pyx_k_cuadro), 0, 0, 1, 1},
  {&__pyx_n_s_dict, __pyx_k_dict, sizeof(__pyx_k_dict), 0, 0, 1, 1},
  {&__pyx_n_s_draw_canvas, __pyx_k_draw_canvas, sizeof(__pyx_k_draw_canvas), 0, 0, 1, 1},
  {&__pyx_n_s_draw_circle, __pyx_k_draw_circle, sizeof(__pyx_k_draw_circle), 0, 0, 1, 1},
  {&__pyx_n_s_draw_processing_parallel, __pyx_k_draw_processing_parallel, sizeof(__pyx_k_draw_processing_parallel), 0, 0, 1, 1},
  {&__pyx_kp_s_draw_processing_parallel_pyx, __pyx_k_draw_processing_parallel_pyx, sizeof(__pyx_k_draw_processing_parallel_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_dtype_is_object, __pyx_k_dtype_is_object, sizeof(__pyx_k_dtype_is_object), 0, 0, 1, 1},
  {&__pyx_n_s_eje_X, __pyx_k_eje_X, sizeof(__pyx_k_eje_X), 0, 0, 1, 1},
  {&__pyx_n_s_eje_Y, __pyx_k_eje_Y, sizeof(__pyx_k_eje_Y), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_template_array, __pyx_k_template_array, sizeof(__pyx_k_template_array), 0, 0, 1, 1},
 ...
 *     cdef int eje_X=circulo.data.as_ints[1]
 */
  __pyx_tuple__20 = PyTuple_Pack(18, __pyx_n_s_circulo, __pyx_n_s_cuadro, __pyx_n_s_width, __pyx_n_s_height, __pyx_n_s_eje_Y, __pyx_n_s_eje_X, __pyx_n_s_radio, __pyx_n_s_color_red, __pyx_n_s_color_green, __pyx_n_s_color_blue, __pyx_n_s_red, __pyx_n_s_green, __pyx_n_s_blue, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_h, __pyx_n_s_w, __pyx_n_s_index); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(4, 0, 18, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_draw_processing_parallel_pyx, __pyx_n_s_draw_circle, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 6, __pyx_L1_error)
 ...
 *     cdef unsigned int w = width
 */
  __pyx_tuple__22 = PyTuple_Pack(10, __pyx_n_s_width, __pyx_n_s_height, __pyx_n_s_i, __pyx_n_s_w, __pyx_n_s_h, __pyx_n_s_size, __pyx_n_s_template_array, __pyx_n_s_red, __pyx_n_s_green, __pyx_n_s_blue); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(2, 0, 10, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_draw_processing_parallel_pyx, __pyx_n_s_draw_canvas, 48, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 48, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initdraw_processing_parallel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initdraw_processing_parallel(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_draw_processing_parallel(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_draw_processing_parallel(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_draw_processing_parallel(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'draw_processing_parallel' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_draw_processing_parallel(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("draw_processing_parallel", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_draw_processing_parallel) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "draw_processing_parallel")) {
      if (unlikely(PyDict_SetItemString(modules, "draw_processing_parallel", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int eje_X=circulo.data.as_ints[1]
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_24draw_processing_parallel_1draw_circle, NULL, __pyx_n_s_draw_processing_parallel); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_draw_circle, __pyx_t_1) < 0) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     cdef unsigned int w = width
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_24draw_processing_parallel_3draw_canvas, NULL, __pyx_n_s_draw_processing_parallel); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_draw_canvas, __pyx_t_1) < 0) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "draw_processing_parallel.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init draw_processing_parallel", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init draw_processing_parallel");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
